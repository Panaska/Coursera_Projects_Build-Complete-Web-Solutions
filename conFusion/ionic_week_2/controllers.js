...
.controller('AppCtrl', function($scope, $timeout, $ionicModal) {
  ...
  $ionicModal.fromTemplateUrl('templates/login.html', {
    ...
    $scope.guestLogin = modal;
  });

  // Triggered in the login modal to close it
  $scope.closeLogin = function() {
    $scope.guestLogin.hide();
  };

  // Open the login modal
  $scope.login = function() {
    $scope.guestLogin.show();
  };
...
*/
			...
			$scope.addFavoriteDish = function(index) {			favoriteFactory.addToFavorites(index);
						console.log("index is " + index);		
						$scope.popover.hide(); 
			}
